function [ materials_contact_boundary ] = define_materials_with_variable_E_contact_boundary( Density,Elasticity,alpha_Rayleigh,beta_Rayleigh,composite,structural,CONTACT_ON , ROOTS)
...
material_prop1=sprintf(['** MATERIALS\n'...
    '**\n'... 
    '*Material, name=wood1\n'...
...
material_prop2=sprintf(['** MATERIALS\n'...
    '**\n'... 
    '*Material, name=wood2\n'...
    '*Damping, alpha=' num2str(alpha_Rayleigh) ', beta=' num2str(beta_Rayleigh) ', composite=' num2str(composite) ', structural=' num2str(structural) '\n'... %This refers to Rayleigh mass damping, stiffness damping, composit and structural
    '*Density\n'...
    '' num2str(Density) ',\n'...  %Density in kg/m3
    '*Elastic\n'...
    '' num2str(0.9*Elasticity) ', 0.38']);
material_prop3=sprintf(['** MATERIALS\n'...
    '**\n'... 
    '*Material, name=wood3\n'...
    '*Damping, alpha=' num2str(alpha_Rayleigh) ', beta=' num2str(beta_Rayleigh) ', composite=' num2str(composite) ', structural=' num2str(structural) '\n'... %This refers to Rayleigh mass damping, stiffness damping, composit and structural
    '*Density\n'...
    '' num2str(Density) ',\n'...  %Density in kg/m3
    '*Elastic\n'...
    '' num2str(0.8*Elasticity) ', 0.38']);
material_prop4=sprintf(['** MATERIALS\n'...
    '**\n'... 
    '*Material, name=wood4\n'...
    '*Damping, alpha=' num2str(alpha_Rayleigh) ', beta=' num2str(beta_Rayleigh) ', composite=' num2str(composite) ', structural=' num2str(structural) '\n'... %This refers to Rayleigh mass damping, stiffness damping, composit and structural
    '*Density\n'...
    '' num2str(Density) ',\n'...  %Density in kg/m3
    '*Elastic\n'...
    '' num2str(0.7*Elasticity) ', 0.38']);
material_prop5=sprintf(['** MATERIALS\n'...
    '**\n'... 
    '*Material, name=wood5\n'...
    '*Damping, alpha=' num2str(alpha_Rayleigh) ', beta=' num2str(beta_Rayleigh) ', composite=' num2str(composite) ', structural=' num2str(structural) '\n'... %This refers to Rayleigh mass damping, stiffness damping, composit and structural
    '*Density\n'...
    ...
    materials_contact_boundary=strvcat(material_prop1,material_prop2,material_prop3,material_prop4,material_prop5,contact,boundary);
