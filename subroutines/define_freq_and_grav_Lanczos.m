function [ frequency_and_gravity_step ] = define_freq_and_grav_Lanczos( FREQUENCY_ON, GRAVITY_ON, ADD_ROOTS )
...
%step.
   ...
   %Gravity step with output suppressed.
    ...
    '*Frequency, eigensolver=Lanczos, normalization=displacement, sim=no\n'...
    '50,0 ,3 ,,, 50\n'...
    '** OUTPUT REQUESTS\n'...
