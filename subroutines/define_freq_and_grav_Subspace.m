function [ frequency_and_gravity_step ] = define_freq_and_grav_Subspace( FREQUENCY_ON, GRAVITY_ON, ADD_ROOTS )
...
%step.
   ...
   %Gravity step with output suppressed.
    ...
    '*Frequency, eigensolver=subspace, normalization=displacement, sim=no\n'...
    '50,4 ,0.2 ,, 50\n'...
    '** OUTPUT REQUESTS\n'...
